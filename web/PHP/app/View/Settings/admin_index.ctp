<div class="settings index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('ride_distance_radius'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($setting['Setting']['ride_distance_radius']); ?>&nbsp;</td>
		<td><?php echo h($setting['Setting']['admin_email']); ?>&nbsp;</td>
		<td class="actions">
