...
<?php echo $this->Form->create('PaymentSetting'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Payment Setting'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PaymentSetting.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PaymentSetting.id'))); ?></li>
