<div class="heatZones index">
	...
	<tr>
		<td><?php echo h($heatZone['HeatZone']['id']); ?>&nbsp;</td>
		<td><?php echo h($heatZone['HeatZone']['name']); ?>&nbsp;</td>
		<td><?php echo h($heatZone['HeatZone']['create_time']); ?>&nbsp;</td>
		<td><?php echo h($heatZone['HeatZone']['is_active']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $heatZone['HeatZone']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $heatZone['HeatZone']['id'])); ?>
