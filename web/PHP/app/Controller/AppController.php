 ...
 */
	...
	public $minimumcreditforride=0;
	public $buycreditwarning=0;
...
*/
	...
	public function siteconfiguration($company_id=1){
		...
		if(is_array($configuration) && count($configuration)>0){
			...
			$this->minimumcreditforride=$configuration['Configuration']['minimumcreadit'];
			$this->buycreditwarning=$configuration['Configuration']['buycreditwarning'];
		}
	}
	...
	public function userrattingsection($userid=0,$type=0){
		...
		if($userid>0 && $type>0){
			...
			if(isset($userrating) && isset($userrating['userratting'])){
				$ratting = number_format(($userrating['userratting']>5 || $userrating['userratting']==0 )?5:$userrating['userratting'],1);
			}
